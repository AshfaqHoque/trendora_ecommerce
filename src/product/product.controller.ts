import { Controller, Get, Post, Body, Patch, Param, Delete, ParseIntPipe, Put, Query, UseGuards, Request, UseInterceptors, UploadedFile } from '@nestjs/common';
...
export class ProductController {
  ...
  createProductWithImage( @UploadedFile() file: Express.Multer.File, @Body() createProductDto: CreateProductDto, @Request() req) {
    if (file) createProductDto.image = `/uploads/${file.filename}`; // save the file path
    return this.productService.createWithImage(createProductDto, req.user);
  }
